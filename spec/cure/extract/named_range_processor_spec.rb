...
RSpec.describe Cure::Extract::NamedRangeProcessor do
  ...
  describe "#process_row" do
    it "will extract the bounds" do
      ...
      expect(results[0]).to eq({:_id=>2, :column_1=>"a1", :column_2=>"a2", :column_3=>"a3", :column_4=>"a4", :column_5=>"a5", :column_6=>"a6"})
      expect(results[1]).to eq({:_id=>3, :column_1=>"b1", :column_2=>"b2", :column_3=>"b3", :column_4=>"b4", :column_5=>"b5", :column_6=>"b6"})
      expect(results[2]).to eq({:_id=>4, :column_1=>"c1", :column_2=>"c2", :column_3=>"c3", :column_4=>"c4", :column_5=>"c5", :column_6=>"c6"})
      expect(results[3]).to eq({:_id=>5, :column_1=>"d1", :column_2=>"d2", :column_3=>"d3", :column_4=>"d4", :column_5=>"d5", :column_6=>"d6"})
    end
  end
